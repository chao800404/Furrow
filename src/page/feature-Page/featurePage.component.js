...
import { feature, imgArr, imgArr1 } from "./featurePage.data";
          ...
          >
            ...
            >
              <FeatureGlassesBtn
                ...
                left="50%"
              >
                <span style={{ top: "-10rem" }}>{feature["property"][0]}</span>
                <BsPlusCircleFill />
              </FeatureGlassesBtn>
              ...
              <FeatureGlassesBtn
                ...
                left="33%"
              >
                <span style={{ left: "-14rem" }}>{feature["property"][1]}</span>
                <BsPlusCircleFill />
              </FeatureGlassesBtn>
              <FeatureGlassesBtn
                whileTap={{ scale: 0.95 }}
                ...
                right="25%"
              >
                <span style={{ top: "-5rem", right: "-20rem", width: "20rem" }}>
                  {feature["property"][2]}
                </span>
                <BsPlusCircleFill />
              </FeatureGlassesBtn>

              <img style={{ width: "150%" }} alt="glasses" src={featureImg} />
            </div>
          </div>
        </FeatureFunction>
      </Flex>
